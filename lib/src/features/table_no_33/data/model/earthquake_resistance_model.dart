...
class EarthquakeResistanceModel with _$EarthquakeResistanceModel{
  ...
  factory EarthquakeResistanceModel({
    ...
    @JsonKey(name: "ward_f_earthquake_resis_count") required int? earthquakeResistance,
    @JsonKey(name: "ward_f_no_earthquake_resis_count") required int? notEarthquakeResistance,
    @JsonKey(name: "total_ward_earthquake_resis_count") required int? total,

}) = _EarthquakeResistanceModel;

  factory EarthquakeResistanceModel.fromJson(Map<String, dynamic> json) => _$EarthquakeResistanceModelFromJson(json);
