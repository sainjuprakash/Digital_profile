                      ...
                      rows: fetchedLiteracyModel.asMap().entries.map((e) {
                        return DataRow(
                            ...
                            cells: [
                              ...
                              DataCell(
                                  Text(e.value.malePrimary?.toString() ?? '-')),
                              DataCell(Text(
                              ...
                              DataCell(
                                  Text(e.value.maleMasters?.toString() ?? '-')),
                              DataCell(
                        ...
                        ..add(DataRow(
                            ...
                            cells: [
                              ...
                              DataCell(Text(totalMaleNotAvailable.toString())),
                      ...
                      rows: fetchedLiteracyModel.asMap().entries.map((e) {
                        return DataRow(
                            ...
                            cells: [
                              ...
                              DataCell(
                                  Text(e.value.femaleMphil?.toString() ?? '-')),
                              DataCell(Text(
                        ...
                        ..add(DataRow(
                            ...
                            cells: [
                              ...
                              DataCell(Text(totalFemalePrePrimary.toString())),
                              ...
                              DataCell(Text(totalFemaleIlliterate.toString())),
                              DataCell(
