...
class IndividualFamilyData with _$IndividualFamilyData {
  ...
  factory IndividualFamilyData({
    ...
    @JsonKey(name: "group_family/Marital_status") required String maritalStatus,
    @JsonKey(name: "group_family/Education") required String education,
    @JsonKey(name: "group_family/any_specialist") required String specialist,
    @JsonKey(name: "group_family/Occupation") required String occupation,
